...
\begin{enumerate}
    ...
    \item The Brain level 1, where the pump, two heaters, airflow sensor, one temperature sensor and an inline pressure sensor are located.
...
The PCB was made using Eagle software. The traces have a width designed to fit the IPC-2221 standards\cite{IPC-2221B}. The PCB layout can be seen in in Section \ref{sec:pcbSchematics}. 
