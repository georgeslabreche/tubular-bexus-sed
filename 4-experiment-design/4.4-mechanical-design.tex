...
The Center Of Gravity appears to be located just on the third level of The Brain. The latter %continua tu Jordi
...
\input{4-experiment-design/tables/materials_prop.tex}
...
\input{4-experiment-design/tables/bags_dimensions.tex}
...
The walls will properly protect both the CAC coiled tube and the AAC sampling bags from any external element, unexpected rapid movements, and a probable hard landing impact. %see in Figure \ref{walls}. 
