...
\input{3-project-planning/tables/effort-allocations-stages-highlighted.tex}
...
%DIFDELCMD < %%%
%DIF < \input{3-project-planning/tables/budget.tex}
...
\input{4-experiment-design/tables/component-table-electronics-highlighted.tex}
\end{landscape}
...
\begin{landscape}
\input{4-experiment-design/tables/component-table-other-highlighted.tex}
\end{landscape}
...
\input{4-experiment-design/tables/mechanics_summary_highlighted.tex}
...
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/01-valves-test.tex}
\DIFaddend \begin{table}[H]
\centering
...
%DIFDELCMD < \centering
%DIFDELCMD < %%%
\DIFdelendFL %DIF > \input{5-experiment-verification-and-testing/tables/test-tables/06-assembly-test.tex}
...
\raggedbottom
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/11-electronics-test.tex}
\begin{table}[H]
\centering
...
\raggedbottom
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/13-gs-obc-connection-test.tex}
\begin{table}[H]
\centering
...
%DIFDELCMD < \raggedbottom
%DIFDELCMD < %%%
\DIFdelend %DIF > \input{5-experiment-verification-and-testing/tables/test-tables/15-gs-obc-invalidcommand-test.tex}
...
\raggedbottom
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/21-arduino-sensor-op-test.tex}
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/22-arduino-pump-valves-test.tex}
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/23-pump-thermal-test.tex}
\begin{table}[H]
\centering
...
\raggedbottom
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/26-insulation-low-pressure-test.tex}
\begin{table}[H]
\centering
...
\raggedbottom
%DIF > \input{5-experiment-verification-and-testing/tables/test-tables/XX-aac-reusability.tex}
...
\input{appendix/appendix-i-highlighted.tex}
...
\newpage
\newpage
\input{appendix/appendix-l-highlighted.tex}
...
\end{figure}
\end{landscape}
%DIF > \input{appendix/appendix-p.tex}
