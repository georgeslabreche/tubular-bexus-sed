...
Table {\ref{tab:thermal-table}}, below covers the thermal ranges of all components to be included in the experiment's flight stage as listed in Section \ref{sec:experiment-components}:
